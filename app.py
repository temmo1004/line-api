...
def index():
    return jsonify({
        ...
        "endpoints": [
            ...
            {"method": "POST", "path": "/v1/messages/sync",           "scope": "read",  "desc": "從 bridge 同步歷史訊息（含群組）", "params": {"limit": "int 最多2000"}},
            {"method": "GET",  "path": "/v1/chats",                   "scope": "read",  "desc": "聊天列表含名稱（含群組）", "params": {"limit": "int 最多500"}},
